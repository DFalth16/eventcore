...
.success-msg{background:var(--lime-g);color:var(--lime);border:1px solid rgba(163,230,53,.2);padding:10px 14px;border-radius:var(--r2);font-size:12px;margin-bottom:16px;text-align:center}
  ...
  <div class="login-card">
    ...
    <form method="POST" action="/login">
      ...
      <div class="form-group">
        <label>Email</label>
        <input type="email" name="email" class="form-control" placeholder="tu@email.com" value="{{ old('email') }}" required autofocus>
      </div>
      <div class="form-group">
    ...
    <div class="login-footer">
      ¿Eres nuevo? <a href="/register">Regístrate aquí</a><br><br>
